...
export const en: Strings = {
  ...
  tours: {
    ...
    unpublishTitle: 'Remove from public?', unpublishMessage: 'Anyone who saved it keeps their copy.',
    ...
    reported: 'Reported. You will not see it again.', authorA11y: (nickname: string) => `Profile of the author ${nickname}`,
    ...
    errors: {
      ...
      publicText: 'I won’t publish this. Public tours can’t be about who drinks more or faster, and can’t carry links or phone numbers.',
      publicChallenge: (name: string) => `${name}: I won’t publish this challenge. Public challenges can’t be about who drinks more or faster, and can’t carry links or phone numbers.`,
