...
export const en: Strings = {
  ...
  addPub: {
    ...
    placeLookupUnavailable: "The place didn't load. You can confirm the location above.",
    missingName: 'Add the pub name.',
    missingLocation: 'Confirm the pub location above.',
    missingAddress: 'Add the city and address.',
    missingEdit: 'Change the name or confirm a new location.',
    cityLabel: 'Town',
  ...
  pubList: {
    ...
    priceChip: 'Price',
    gamesChip: 'Games',
    moreFiltersChip: 'More',
    beerChip: 'Beer',
    beerChipCount: (count: number) => `Beer (${count})`,
    beerChipA11y: (names: string) => `Beer: ${names}`,
    beerChipPick: 'Pick beers',
    priceChipA11y: 'Filter by beer price',
    gamesChipA11y: 'Filter by pub games',
    moreFiltersChipA11y: 'Open more pub filters',
    tankChipA11y: 'Filter pubs with tank beer',
  ...
  liveParty: {
    ...
    // Before the night
    idleTable: 'Table',
    a11yOpenTable: 'Table. Invite people, or join with a code.',
    idleInviteLink: 'Invite to the table',
    joinHint: 'Got a code?',
    ...
    a11yPickDrink: 'Pick a beer',
    a11yFirstDrink: (action: string, drink: string) => `${action}: ${drink}`,
    startNight: 'Log the first beer',
    logBeer: 'Log a beer',
    pickDrink: 'What are you having?',
