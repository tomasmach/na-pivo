...
export const en: Strings = {
  ...
  onboarding: {
    ...
    slide2Body: 'You tally beers like on a beer mat, stats and badges pop up on their own. Add friends, see who is sitting in a pub right now, and clink glasses from afar.',
  ...
  settings: {
    ...
    accountCard: {
      ...
      signedOutSubtitle: 'Sync beers, ratings and badges across all your devices',
    },
    distance: {
    ...
    pubReminders: {
      ...
      denied: {
        ...
        'foreground-location-denied': {
          ...
          body: 'Location while using the app is the basis for the compass and for pubs nearby. Once you allow it, I will sort out "always" location for the reminders.',
        },
    ...
    beerCountReminder: {
      ...
      subtitle: "After every beer I move one reminder along. It doesn't repeat on its own.",
      intervalLabel: 'In',
  ...
  report: {
    ...
    attachmentSourceTitle: 'Where do we take the photo from?',
    ...
    successTitle: 'Thanks! 🍺',
    successBody: "The message will arrive even if there's no connection right now. I send it as soon as you're online.",
    successClose: 'Close',
  },
  contribute: {
    title: 'Add info',
  ...
  addPub: {
    ...
    locationBody: "Add the pub where you're standing right now. We save only this point, no route and no location history.",
  ...
  account: {
    ...
    subscriptionRestoreUnavailableBody: 'The account is already set up to hold restored purchases. Once the purchase SDK lands, receipt verification plugs in here.',
  ...
  communityEvents: {
    ...
    exactAddressHint: 'We never show it in the public list. Only the people you approve get it.',
    ...
    reportComment: 'Reported from the community meetups list.',
  },
  photoDiary: {
    header: 'BEER PHOTOS',
    title: 'Beer photos',
  ...
  friends: {
    ...
    emptyActive: 'None of your friends is lit up in a pub right now.',
    ...
    ghostSubtitle: 'The crew cannot see where you are sitting or what you have drunk. Your pings stay with you.',
  ...
  counter: {
    ...
    backdateTitle: 'When did you have it?',
  ...
  vycep: {
    ...
    reportBody: "The report comes to us anonymously. We'll take a look.",
    reportConfirm: 'Report it',
    reportSentToast: "Thanks, got it. We'll take a look.",
    reportErrorToast: 'The report did not get through. Try again.',
  },
  myBeers: {
    title: 'My beers',
    emptyTitle: 'No beer trail yet',
    emptyBody: 'Tap a beer in the Counter and the night saves itself here. You will see where it was, what you drank and what it added up to.',
    ...
    historicalSubtitle: 'The same entry, just finished after the fact.',
  ...
  stats: {
    ...
    emptyBody: 'Start counting beers and in the morning you find your performance here: how many went down, how fast and where.',
  ...
  auth: {
    ...
    unsupported: 'This option is not available on this device.',
    socialMisconfigured: 'Google sign-in is not set up properly right now. Try signing in with email for now.',
