...
export const en: Strings = {
  ...
  tours: {
    ...
    crewSheetNote: 'Whoever scans it joins you. They will see your nickname and who else is going.', crewShareLink: 'Send the link',
    crewShareMessage: (title: string, url: string) => `We’re doing the tour “${title}”. Join us: ${url}`, crewQrA11y: 'QR code to join the crew',
