...
export const en: Strings = {
  ...
  addPub: {
    ...
    locationBody: 'Find the pub by address, look up the address of where you stand, or mark it with a pin on the map.',
    ...
    pickOnMap: 'Drop a pin on the map',
  ...
  tours: {
    ...
    reported: "Reported. I won't show it on this phone again.", reportFailed: 'The report did not go through. Try again.',
    ...
    shareNotice: 'Anyone with the link can see the tour name, meetup, selected pubs and challenges. I never share your movement, progress or drinks.',
    ...
    importUpdate: 'There is a newer plan', updateMessage: 'The plan has changed. Your progress so far stays attached to the original plan.',
    ...
    errors: {
      ...
      publicHidden: 'This tour is hidden after reports. I’ll take a look.', publicLimit: (count: number) => `You can have at most ${count} public tours. Remove one first.`,
  ...
  a11y: {
    ...
    addPubPickOnMapButton: 'Drop the pub pin on the map',
    addPubMapPinSelected: 'The pub pin is on the map, tap to move it',
    mapPinCancel: 'Close the map',
