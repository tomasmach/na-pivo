...
export const cs = {
  ...
  tours: {
    ...
    crewSheetNote: 'Kdo to naskenuje, přidá se k vám. Uvidí tvoji přezdívku a kdo další jde.', crewShareLink: 'Poslat odkaz',
    crewShareMessage: (title: string, url: string) => `Jdeme na tour „${title}“. Přidej se: ${url}`, crewQrA11y: 'QR kód pro připojení k partě',
