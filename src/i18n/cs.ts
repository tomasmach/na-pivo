...
export const cs = {
  ...
  addPub: {
    ...
    locationWithCurrent: 'Začni psát název a vyber podnik z návrhů Mapy.cz. Když tam není, doplň adresu ručně.',
    locationFromAddress: 'Začni psát název a vyber podnik z návrhů Mapy.cz. Když tam není, doplň adresu ručně.',
    nameLabel: 'Název',
