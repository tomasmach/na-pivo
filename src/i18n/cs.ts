...
export const cs = {
  ...
  settings: {
    ...
    donate: {
      title: 'Podpoř autora',
      subtitle: 'Pošli libovolnou částku, pokud se ti hodila 🍺',
      headerEyebrow: 'PODPOŘ AUTORA',
      sheetTitle: 'Podpoř autora 🍺',
      body1: 'Pokud se ti aplikace líbí, můžeš autorovi poslat dobrovolný příspěvek v libovolné výši.',
      body2: 'Platba probíhá mimo App Store v Safari přes Stripe. V aplikaci se nic neodemyká — všechno tu zůstává zdarma a bez reklam.',
      openCta: 'Otevřít stránku pro podporu',
      safariNote: 'Otevře se Safari · Platba přes Stripe',
      cancel: 'Zavřít',
    },
  ...
  privacy: {
    ...
    body: [
      ...
      'Volitelná podpora autora („Podpoř autora") probíhá mimo App Store v prohlížeči Safari přes Stripe. Příspěvek je dobrovolný, v aplikaci se nic neodemyká. Platby se řídí podmínkami Stripe.',
    ],
