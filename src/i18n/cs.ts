...
export const cs = {
  ...
  tours: {
    ...
    empty: 'Vyber hospody a sestav si vlastní večer.', edit: 'Upravit', editTour: 'Upravit tour',
    untitled: 'Rozepsaná tour', draft: 'Rozepsaná', continueDraft: 'Pokračovat v rozepsané tour',
    ready: 'Připravená', imported: 'Uložená z odkazu', active: 'Právě jdeš', ended: 'Ukončeno',
