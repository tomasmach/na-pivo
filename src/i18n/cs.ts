...
export const cs = {
  ...
  tours: {
    ...
    unpublishTitle: 'Stáhnout z veřejných?', unpublishMessage: 'Kdo si ji uložil, tomu zůstane.',
    ...
    reported: 'Nahlášeno. Už ji neuvidíš.', authorA11y: (nickname: string) => `Profil autora ${nickname}`,
    ...
    errors: {
      ...
      publicText: 'Tohle nezveřejním. Veřejné tour nesmí být o tom, kdo víc nebo rychleji vypije, ani nést odkazy a čísla.',
      publicChallenge: (name: string) => `${name}: tuhle výzvu nezveřejním. Veřejné výzvy nesmí být o tom, kdo víc nebo rychleji vypije, ani nést odkazy a čísla.`,
