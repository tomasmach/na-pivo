...
export const cs = {
  ...
  privacy: {
    title: 'Soukromí',
    body: [
      'Sbírám omezené provozní a produktové statistiky: otevření aplikace, zobrazení hlavních obrazovek, použití vybraných funkcí, technické chyby, verzi aplikace a součet nachozených metrů.',
