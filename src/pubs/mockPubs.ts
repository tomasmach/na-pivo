...
export const MOCK_PUBS: MockPub[] = [
  ...
  },
  {
    ...
    lat: 50.0755,
    lng: 14.4405,
    name: 'Pivovarský klub',
    distance: '2,1 km',
    address: 'Křižíkova 17, Karlín',
    open: true,
    hours: 'do 23:30',
    beer: 'Kout na Šumavě 12°',
    priceCzk: 55,
    rating: 4.5,
    lastParty: null,
  },
  {
    ...
    name: 'U Kurelů',
    distance: '2,3 km',
    address: 'Lublaňská 42, Vinohrady',
    open: false,
    hours: 'otevře v 16:00',
    beer: 'Svijany 11°',
    priceCzk: 42,
    rating: 4.2,
    lastParty: null,
  },
  {
    ...
    open: true,
    hours: 'do 00:00',
    beer: 'Pilsner Urquell nefiltrovaný',
    priceCzk: 62,
    rating: 4.4,
    lastParty: 'Byli jste tu 2× · před měsícem',
  },
  {
    id: 'p9',
    lat: 50.0632,
    ...
    name: 'Base Camp',
    distance: '2,9 km',
    address: 'Bělehradská 60, Vinohrady',
    open: true,
    hours: 'do 22:30',
    beer: 'Zichovec Session IPA',
    priceCzk: 68,
    rating: 4.1,
    lastParty: null,
  },
  ...
  },
  {
    ...
    name: 'Klášterní šenk',
    distance: '3,6 km',
    address: 'Strahovské nádvoří 10, Strahov',
    open: false,
    hours: 'otevře zítra v 11:00',
    beer: 'Sv. Norbert tmavý',
    priceCzk: 72,
    rating: 3.9,
    lastParty: null,
  },
