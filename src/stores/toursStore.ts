...
function data(): ToursData {
  ...
  return cloneTour({ version: s.version, owner: s.owner, plans: s.plans, draft: s.draft, activeRun: s.activeRun, runs: s.runs, published: s.published, pending: s.pending });
}
