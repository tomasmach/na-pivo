...
const { cs } = jest.requireActual('@/i18n/cs') as typeof import('@/i18n/cs');
const BeerPhotoDetailScreen = jest.requireActual('@/photos/BeerPhotoDetailScreen').default as typeof import('@/photos/BeerPhotoDetailScreen').default;
