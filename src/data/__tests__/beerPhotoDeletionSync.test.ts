...
} = jest.requireActual('../beerPhotoDeletionTombstones') as typeof import('../beerPhotoDeletionTombstones');
const {
...
} = jest.requireActual('../beerPhotoDeletionSync') as typeof import('../beerPhotoDeletionSync');
