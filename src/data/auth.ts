...
/**
 * Parse a raw achievements block. Shared with the friend-profile detail, which
 * carries the same block for public profiles. Every badge is additive and
 * defaults to false on older backends.
 */
