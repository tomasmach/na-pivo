  ...
  return (
    <Stack
      screenOptions={{
        ...
        // iOS 26 adds its own scroll-edge glass by default. This stack already
        // supplies the product's dark material, so stacking both creates a
        // muddy double blur and react-native-screens warns about the overlap.
        scrollEdgeEffects: {
          top: 'hidden',
          bottom: 'hidden',
          left: 'hidden',
