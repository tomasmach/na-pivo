  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top + 12 }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t.account.authTitle}</Text>
      ...
      >
          ...
          <View style={styles.segmented}>
            {(['login', 'register'] as const).map((value) => {
              ...
              const label = value === 'login' ? t.account.tabLogin : t.account.tabRegister;
              return (
                <Pressable
                  key={value}
                  ...
                  accessibilityLabel={
                    value === 'login' ? t.a11y.authTabLogin : t.a11y.authTabRegister
                  }
                >
                  <Text
          ...
          {mode === 'register' && (
            <View style={styles.fieldGroup}>
              <Text style={styles.label}>{t.account.nicknameLabel}</Text>
              <NicknameField
                value={nickname}
                onChangeText={(value) => {
                  setNickname(value);
          ...
          <View style={styles.dividerRow}>
            ...
            <Text style={styles.dividerText}>{t.account.orDivider}</Text>
            <View style={styles.dividerLine} />
          </View>
