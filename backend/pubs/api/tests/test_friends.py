...
def test_tour_ping_names_the_tour_and_old_payload_keeps_its_wording(client, monkeypatch):
    ...
    assert heading["body"] == "@janek jde tour „Pivní okruh Starým Městem“ a míří do U Zlatého tygra. Přidáš se?"
    ...
    assert sitting["body"] == "@janek jde tour „Pivní okruh Starým Městem“ a sedí v U Medvídků. Přidáš se?"
